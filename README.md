...
To grant even more protection I'd also suggest to use 1-2 small batteries to have extra time to safely shut off the unit in case of an emergency or other use cases, however it's an option that one can choose to have.
